...
namespace TMRazorImproved.Tests.MockTests.Agents
{
    public class AutoLootServiceTests
    {
        ...
        public AutoLootServiceTests()
        {
            ...
            // Mock DragDropCoordinator to return success by default
        ...
        public async Task HandleContainerContent_ShouldEnqueueAndLootItems()
        {
            ...
            // Assert
            _dragDropCoordinatorMock.Verify(d => d.RequestDragDrop(0x11111111, 0x44444444, 100), Times.Once);
        ...
        public async Task HandleSingleItem_ShouldEnqueueAndLootItem()
        {
            ...
            // Assert
            _dragDropCoordinatorMock.Verify(d => d.RequestDragDrop(0x99999999, 0x44444444, 1), Times.Once);
