    ...
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        internal void AutolootSetBag()
        {
            if (showagentmessageCheckBox.Checked)
                RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgAutolootSelectLootBag"), false);
            ...
            if (autolootListSelect.Text != String.Empty)
                ...
                AutoLoot.AddLog(LanguageHelper.GetString("MsgItemListNotSelected"));
        }
        ...
        private void autoLootSetContainerTarget_Callback(bool loc, Assistant.Serial serial, Assistant.Point3D pt, ushort itemid)
        {
            ...
            {
                if (showagentmessageCheckBox.Checked)
                    RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgAutolootContainerSet") + autoLootBag.ToString(), false);
                RazorEnhanced.AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootContainerSet") + autoLootBag.ToString());
                AutoLoot.AutoLootBag = (int)autoLootBag.Serial.Value;
            }
            else
            {
                if (showagentmessageCheckBox.Checked)
                    RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgInvalidAutolootContainer"), false);
                RazorEnhanced.AutoLoot.AddLog(LanguageHelper.GetString("MsgInvalidAutolootContainer"));
        ...
        {
            if (showagentmessageCheckBox.Checked)
                RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgSelectAutolootItem"), false);
        ...
        private void autoLootItemTarget_Callback(bool loc, Assistant.Serial serial, Assistant.Point3D pt, ushort itemid)
        {
            ...
            {
                if (showagentmessageCheckBox.Checked)
                    RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgAutolootItemAdded") + autoLootItem.ToString(), false);
                RazorEnhanced.AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootItemAdded") + autoLootItem.ToString());
            ...
            else
            {
                ...
                RazorEnhanced.AutoLoot.AddLog(LanguageHelper.GetString("MsgInvalidTarget"));
            }
        }
        ...
        private void autoLootEnable_CheckedChanged(object sender, EventArgs e)
        {
            if (World.Player == null)  // offline
            {
                ...
                {
                    AutoLoot.AddLog(LanguageHelper.GetString("MsgNotLoggedIn"));
            ...
            if (autoLootCheckBox.Checked)
            {
                ...
                AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootEngineStart"));
                if (showagentmessageCheckBox.Checked)
                    Misc.SendMessage(LanguageHelper.GetString("MsgAutolootEngineStartMsg"), false);
            }
            else
            {
                ...
                if (showagentmessageCheckBox.Checked)
                    Misc.SendMessage(LanguageHelper.GetString("MsgAutolootEngineStopMsg"), false);
                AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootEngineStop"));
            }
        }
        ...
        private void autoLootListSelect_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (autolootListSelect.Focused && autolootListSelect.Text != String.Empty)
            {
                ...
                AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootListChanged") + autolootListSelect.Text);
            }
        ...
        private void autoLootButtonRemoveList_Click(object sender, EventArgs e)
        {
            if (autolootListSelect.Text != String.Empty)
            {
                var dialogResult = RazorEnhanced.UI.RE_MessageBox.Show(LanguageHelper.GetString("MsgDeleteAutolootListTitle"),
                    string.Format(LanguageHelper.GetString("MsgDeleteAutolootListText"), autolootListSelect.Text),
                    ok: LanguageHelper.GetString("MsgYes"), no: LanguageHelper.GetString("MsgNo"), cancel: null, backColor: null);
                if (dialogResult == DialogResult.Yes)
                {
                    RazorEnhanced.AutoLoot.AddLog(LanguageHelper.GetString("MsgAutolootListRemoved") + autolootListSelect.Text);
