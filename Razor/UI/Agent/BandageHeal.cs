    ...
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        private void bandagehealenableCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if (World.Player != null)
            {
                if (bandagehealenableCheckBox.Checked)
                {
                    ...
                    RazorEnhanced.BandageHeal.AddLog(LanguageHelper.GetString("MsgBandageHealEngineStart"));
                    if (showagentmessageCheckBox.Checked)
                        RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgBandageHealEngineStartMsg"), false);
                }
                else
                {
                    // Stop BANDAGEHEAL
                    ...
                    if (showagentmessageCheckBox.Checked)
                        RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgBandageHealEngineStopMsg"), false);
                    RazorEnhanced.BandageHeal.AddLog(LanguageHelper.GetString("MsgBandageHealEngineStop"));
                }
            }
            else
            {
                bandagehealenableCheckBox.Checked = false;
                RazorEnhanced.BandageHeal.AddLog(LanguageHelper.GetString("MsgNotLoggedIn"));
            }
        ...
        private void BandageHeakMobileTarget_Callback(bool loc, Assistant.Serial serial, Assistant.Point3D pt, ushort itemid)
        {
            ...
            if (mobile == null)
            {
                ...
                RazorEnhanced.BandageHeal.AddLog(LanguageHelper.GetString("MsgInvalidTarget"));
                return;
            }
            ...
            {
                if (showagentmessageCheckBox.Checked)
                    RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgBandageHealTargetSet") + mobile.Name, false);
                RazorEnhanced.BandageHeal.AddLog(LanguageHelper.GetString("MsgBandageHealTargetSet") + mobile.Name);
            ...
            else
            {
                if (showagentmessageCheckBox.Checked)
                    RazorEnhanced.Misc.SendMessage(LanguageHelper.GetString("MsgInvalidTarget"), false);
                RazorEnhanced.Scavenger.AddLog(LanguageHelper.GetString("MsgInvalidTarget"));
            }
        }
