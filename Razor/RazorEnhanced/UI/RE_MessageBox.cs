...
namespace RazorEnhanced.UI
{
    ...
    internal partial class RE_MessageBox : Form
    {
            ...
            Color? backColor = null)
        {
            ...
            this.okButton.Text = LanguageHelper.GetString(ok);
            ...
            else
            {
                ...
                this.noButton.Text = LanguageHelper.GetString(no);
            ...
            else
            {
                ...
                this.cancelButton.Text = LanguageHelper.GetString(cancel);
            ...
            this.Text = LanguageHelper.GetString(title);
            message.Text = LanguageHelper.GetString(msg);
