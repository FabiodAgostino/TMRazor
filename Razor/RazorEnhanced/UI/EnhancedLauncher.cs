...
namespace RazorEnhanced.UI
{
    ...
    {
        private const string m_Title = "Welcome to TM Razor";
        ...
        public EnhancedLauncher()
        {
            ...
            if (Shards.allShards.Language == "en")
                languageComboBox.SelectedIndex = 0;
            else
                languageComboBox.SelectedIndex = 1; // Default to Italian "it"
        ...
        private void RefreshGUI()
        {
            ...
            if (ip == null || ip == System.Net.IPAddress.None || Convert.ToInt32(portLabel.Text) == 0)
            {
                ...
                launchCUO.Enabled = RazorEnhanced.Config.Debug;
                launch.Enabled = RazorEnhanced.Config.Debug;
            }

            if (RazorEnhanced.Config.Debug)
            {
                launch.Enabled = true;
                launchCUO.Enabled = true;
            }
        ...
        {
            string newLang = languageComboBox.SelectedIndex == 0 ? "en" : "it";
