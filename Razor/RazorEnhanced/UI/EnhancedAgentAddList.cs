...
namespace RazorEnhanced.UI
{
    public partial class EnhancedAgentAddList : Form
    {
        ...
        internal void SetAgent(int agentid)
        {
            ...
            {
                case 1:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.AutolootAddList");
                    break;
                case 2:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.ScavengerAddList");
                    break;
                case 3:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.OrganizerAddList");
                    break;
                case 4:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.BuyAddList");
                    break;
                case 5:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.SellAddList");
                    break;
                case 6:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.DressAddList");
                    break;
                case 7:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.FriendAddList");
                    break;
                case 8:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.RestockAddList");
                    break;
                case 9:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.LauncherAddShard");
                    break;
                case 10:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.AutolootCloneList");
                    break;
                case 11:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.ScavengerCloneList");
                    break;
                case 12:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.OrganizerCloneList");
                    break;
                case 13:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.BuyCloneList");
                    break;
                case 14:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.SellCloneList");
                    break;
                case 17:
                    Text = LanguageHelper.GetString("EnhancedAgentAddList.RestockCloneList");
                    break;
            }
        }
